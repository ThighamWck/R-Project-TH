...
# # ===============================
# def load_data(csv_path, grid_size=63):
#     # Load CSV
...
# # ===============================
# def train_model(model, dataloader, num_epochs=500, lr=0.001, patience=20):
#     optimizer = optim.Adam(model.parameters(), lr=lr)
#     criterion = nn.MSELoss()

#     scheduler = optim.lr_scheduler.ReduceLROnPlateau(
#         optimizer,
#         mode='min',          # Reduce LR when monitored value is minimized
#         factor=0.5,          # Multiply LR by this factor (e.g., 0.5 halves the LR)
...
#         scheduler.step(avg_epoch_loss)  # Pass validation loss or epoch loss
#         # Print the learning rate manually after adjustment
...
#         print("Best model restored after early stopping.")
...
#     csv_path = "rho_63_square_train_10000.csv"  # Updated path to your data

#     # Load data
#     dataloader = load_data(csv_path)

#     # Initialize model
#     model = FNO2D(in_channels=4, out_channels=1, modes1=20, modes2=20, width=128).to(device)

#     # Train the model
#     train_model(model, dataloader)

#     # Save the model after training
#     torch.save(model.state_dict(), 'rho_63_square_10000.pth')
